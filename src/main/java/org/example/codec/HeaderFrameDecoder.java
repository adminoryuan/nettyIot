...
public class HeaderFrameDecoder extends ByteToMessageDecoder {
    ...
    private static final int LONGITUDE_LENGTH = 8;
    private static final int LATITUDE_LENGTH = 8;
    private static final int CABINET_ID_LENGTH = 16;
    private static final int CHECKSUM_LENGTH = 4;
    private static final int FRAME_TAIL_LENGTH = 2;
